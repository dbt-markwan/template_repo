...
with customer as (
    ...
    select * from ANALYTICS.prod.stg_tpch_customers

),
nation as (

    select * from ANALYTICS.prod.stg_tpch_nations
),
region as (

    select * from ANALYTICS.prod.stg_tpch_regions

),
customer_flags as (
    select * from ANALYTICS.prod.customer_flags
),
